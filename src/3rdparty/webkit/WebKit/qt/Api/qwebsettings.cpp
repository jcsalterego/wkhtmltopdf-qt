...
/*!
    ...
    left empty the default "print" will be used, other choices include
    "screen" Specifies the default text encoding system.
...
/*!
    \since 4.7
    Returns the printing media-type encoding.
